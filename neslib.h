...
#define MMC1_MIRROR_LOWER_BANK     (0<<0)
#define MMC1_MIRROR_UPPER_BANK     (1<<0)
#define MMC1_MIRROR_VERTICAL       (2<<0)
#define MMC1_MIRROR_HORIZONTAL     (3<<0)
#define MMC1_PRGMODE_SWITCH_32K    (1<<2)
#define MMC1_PRGMODE_SWITCH_LOW8K  (2<<2)
#define MMC1_PRGMODE_SWITCH_HIGH8K (3<<2)
#define MMC1_CHRMODE_SWITCH_8K     (0<<4)
#define MMC1_CHRMODE_SWITCH_4K     (1<<4)
